...
$bodyContent = '<h3>Please click on this verification link to reset your account!</h3>';
$bodyContent .= ' http://localhost:8080/portal/reset_account.php?email='.$email;
$bodyContent .= '&type='.$type;

$mail->Subject = 'Account reset link from Myjob.com';
...
if(!$mail->send()) {
    ...
    echo '<h4>Account reset link has been send to your email. Please click on the verification link to reset your account!</h4>';
